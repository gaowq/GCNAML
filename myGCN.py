...
plt.plot(numpy.array(a), 'r', label='Train loss')
plt.plot(numpy.array(b), 'g', label='Valid loss')
plt.plot(numpy.array(c), 'black', label='Illicit F1')
plt.plot(numpy.array(d), 'orange', label='F1')
plt.ylim([0,1.0])
plt.show()